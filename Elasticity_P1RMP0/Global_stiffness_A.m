...
global A
   ...
   for n=1:NT
       ...
       E=t(4:6,n);%三边序号
       Loc=[3*n-2,3*n-1,3*n,3*n-2+3*NT,3*n-1+3*NT,3*n+3*NT,3*E(1)-2+6*NT,3*E(1)-1+6*NT,3*E(1)+6*NT,3*E(2)-2+6*NT,3*E(2)-1+6*NT,3*E(2)+6*NT,3*E(3)-2+6*NT,3*E(3)-1+6*NT,3*E(3)+6*NT];
